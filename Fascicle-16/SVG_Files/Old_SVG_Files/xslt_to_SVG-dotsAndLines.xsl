    ...
    <xsl:template match="/">
        <svg width="100%" height="100%">
            <g transform="translate(100, 600)">
                ...
                <g id="legend">
                    <circle cx="35" cy="-487" r="25" fill="#0099CC" />
                    <text x="35" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="black">CE</text>
                    <circle cx="95" cy="-487" r="25" fill="#ec008c" />
                    <text x="95" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="black">LSD</text>
                    <circle cx="155" cy="-487" r="25" fill="#D9007E" />
                    <text x="155" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="black">AM</text>
                    <circle cx="215" cy="-487" r="25" fill="#8800CC" />
                    <text x="215" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="white">BM</text>
                    <circle cx="275" cy="-487" r="25" fill="#2200CC" />
                    <text x="275" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="white">FH</text>
                    <circle cx="335" cy="-487" r="25" fill="#00CC00" />
                    <text x="335" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="black">FP</text>
                    <circle cx="395" cy="-487" r="25" fill="#ACE500" />
                    <text x="395" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="black">POEMS3</text>
                    <circle cx="455" cy="-487" r="25" fill="#FFFF00" />
                    <text x="455" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="black">POEMS2</text>
                    <circle cx="515" cy="-487" r="25" fill="#FF9900" />
                    <text x="515" y="-485" text-anchor="middle" font-size="10px" font-family="'Open Sans', sans-serif" fill="black">POEMS1</text>
        ...
        -->        
              ...
              <xsl:text> CE Dash Count: </xsl:text><xsl:value-of select="$dashCountCE"/></xsl:comment> 
                  <xsl:if test="(count(//rdg[@wit[contains(., '#ce')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-45}" x2="{($poemNumber*$x-interval)-45}" y1="0" y2="-{$CER*$y-interval}" stroke="#0099CC" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-45}" cy="-{$CER*$y-interval}" r="4" fill="#0099CC" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#lSD')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-40}" x2="{($poemNumber*$x-interval)-40}" y1="0" y2="-{$lSD*$y-interval}" stroke="#ec008c" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-40}" cy="-{$lSD*$y-interval}" r="4" fill="#ec008c" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#am')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-35}" x2="{($poemNumber*$x-interval)-35}" y1="0" y2="-{$am*$y-interval}" stroke="#D9007E" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-35}" cy="-{$am*$y-interval}" r="4" fill="#D9007E" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#bm')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-30}" x2="{($poemNumber*$x-interval)-30}" y1="0" y2="-{$bm*$y-interval}" stroke="#8800CC" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-30}" cy="-{$bm*$y-interval}" r="4" fill="#8800CC" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#fh')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-25}" x2="{($poemNumber*$x-interval)-25}" y1="0" y2="-{$fh*$y-interval}" stroke="#2200CC" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-25}" cy="-{$fh*$y-interval}" r="4" fill="#2200CC" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#fp')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-20}" x2="{($poemNumber*$x-interval)-20}" y1="0" y2="-{$fp*$y-interval}" stroke="#00CC00" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-20}" cy="-{$fp*$y-interval}" r="4" fill="#00CC00" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#poems3')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-15}" x2="{($poemNumber*$x-interval)-15}" y1="0" y2="-{$poems3*$y-interval}" stroke="#ACE500" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-15}" cy="-{$poems3*$y-interval}" r="4" fill="#ACE500" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#poems2')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-10}" x2="{($poemNumber*$x-interval)-10}" y1="0" y2="-{$poems2*$y-interval}" stroke="#FFFF00" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-10}" cy="-{$poems2*$y-interval}" r="4" fill="#FFFF00" /></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#poems1')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-5}" x2="{($poemNumber*$x-interval)-5}" y1="0" y2="-{$poems1*$y-interval}" stroke="#FF9900" stroke-width="6"/><circle cx="{($poemNumber*$x-interval)-5}" cy="-{$poems1*$y-interval}" r="4" fill="#FF9900" /></xsl:if>
                  </xsl:for-each>
                  </g>
            </g>
        </svg>
