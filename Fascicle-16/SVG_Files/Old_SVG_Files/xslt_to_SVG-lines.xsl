    ...
    <xsl:template match="/">
        ...
        -->        
              ...
              <xsl:text> CE Dash Count: </xsl:text><xsl:value-of select="$dashCountCE"/></xsl:comment> 
                  <xsl:if test="(count(//rdg[@wit[contains(., '#ce')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-45}" x2="{($poemNumber*$x-interval)-45}" y1="0" y2="-{$CER*$y-interval}" stroke="#0099CC" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#lSD')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-40}" x2="{($poemNumber*$x-interval)-40}" y1="0" y2="-{$lSD*$y-interval}" stroke="#ec008c" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#am')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-35}" x2="{($poemNumber*$x-interval)-35}" y1="0" y2="-{$am*$y-interval}" stroke="#D9007E" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#bm')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-30}" x2="{($poemNumber*$x-interval)-30}" y1="0" y2="-{$bm*$y-interval}" stroke="#8800CC" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#fh')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-25}" x2="{($poemNumber*$x-interval)-25}" y1="0" y2="-{$fh*$y-interval}" stroke="#2200CC" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#fp')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-20}" x2="{($poemNumber*$x-interval)-20}" y1="0" y2="-{$fp*$y-interval}" stroke="#00CC00" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#poems3')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-15}" x2="{($poemNumber*$x-interval)-15}" y1="0" y2="-{$poems3*$y-interval}" stroke="#ACE500" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#poems2')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-10}" x2="{($poemNumber*$x-interval)-10}" y1="0" y2="-{$poems2*$y-interval}" stroke="#FFFF00" stroke-width="6"/></xsl:if>
                  
                  <xsl:if test="(count(//rdg[@wit[contains(., '#poems1')]])) &gt; 0"><line x1="{($poemNumber*$x-interval)-5}" x2="{($poemNumber*$x-interval)-5}" y1="0" y2="-{$poems1*$y-interval}" stroke="#FF9900" stroke-width="6"/></xsl:if>
                  </xsl:for-each>
                  </g>
            </g>
        </svg>
